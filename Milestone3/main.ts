function generateCV() {
  ...
  const profession = (document.getElementById('titlefield') as HTMLInputElement).value;
  ...
  const summary = (document.getElementById('summaryfield') as HTMLTextAreaElement).value;
  const imgField = (document.getElementById('imgfield') as HTMLInputElement).files;
  ...
  // Set the links
  const linkdenLink = (document.getElementById('linkdenlinkfield') as HTMLInputElement).value;
  const githubLink = (document.getElementById('githublinkfield') as HTMLInputElement).value;
